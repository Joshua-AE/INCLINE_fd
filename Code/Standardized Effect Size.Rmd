...
```
# 835 SES values, grouped by block and site, we ight overestimate effect sizes due to low sample size per block. Number of paired observations more unbalanced based on blockID, much lower sample size for chem traits than leaf traits
...
panel_plots <- ggplot(SES_combined, aes(x = precip, y = SES, fill = precip)) +
  ...
  ylim(-2.5,2.5) + # otherwise ylim(-5,5)
