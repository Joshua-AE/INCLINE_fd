...
rm(raw_traits, traits1, traits1l, traits1sd, traits2, traits2l, traits2sd, traits3, traits3C, traits3OTC, i)
```
...
species_sd <- species_sd %>% group_by(species) %>% summarise(mean_sd = mean(rel_sd)) # check the NA with Poa pratensis and manually check the calculation
# sd quotient: sd/mean -> corrects for the difference in means between the traits
rm(species_mean)
```
