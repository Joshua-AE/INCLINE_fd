...
chem_traits <- select(chem_traits, c(siteID, blockID, warming, species, trait, value)) %>% na.omit() %>%
  filter(trait %in% c("c_percent", "n_percent", "c_n", "d15n", "d13c", "p_percent")) # no sample removed
